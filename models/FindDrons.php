...
class FindDrons extends \yii\db\ActiveRecord
{
    ...
    {
        return [
            [['id','name_surname','thirdname','drone_id','drone_reg_number','drone_serial_number','email','date','x_coords','y_coords'],'trim'],
    ...
    public static function getIdFromDronSerialNumber($DronRegNumber){
        return FindDrons::find()->where(['drone_serial_number'=>$DronRegNumber])->one()['id'];
    }
